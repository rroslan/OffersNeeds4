...
public class TransportsFragments extends Fragment {
    private static TransportsFragments INSTANCE=null;
    ...
    public static TransportsFragments getInstance(Location location)
    {
        if(INSTANCE == null)
            INSTANCE = new TransportsFragments();
        mLocation = location;
