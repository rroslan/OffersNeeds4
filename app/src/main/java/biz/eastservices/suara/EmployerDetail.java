...
public class EmployerDetail extends AppCompatActivity implements RatingDialogListener {
    ...
    private void loadDetail(String uid) {
        FirebaseDatabase.getInstance()
                .getReference(Common.USER_TABLE_EMPLOYER)
                .child(uid)
        ...
        FirebaseDatabase.getInstance()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(EmployerDetail.this, "Rating Failed", Toast.LENGTH_SHORT).show();
                    }
                });
    }
